#!/usr/bin/env python3
"""
Restaurants Table Migration Fix - Final Version
==============================================

This script specifically migrates the restaurants table from Neon to Oracle Cloud,
using proper SQLAlchemy parameter binding and handling RMKeyView objects correctly.
"""
...
class RestaurantsMigratorFinal:
    ...
    def migrate_restaurants_data(self, rows, columns):
        """Migrate restaurants data with proper SQLAlchemy parameter binding."""
        if not rows:
...
def main():
    ...
    print("🔄 Restaurants Table Migration Fix - Final Version")
    print("=" * 50)
    ...
    # Create migrator
    migrator = RestaurantsMigratorFinal(neon_url, oracle_url)

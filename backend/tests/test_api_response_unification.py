...
from utils.api_response import (  # Success responses; Domain-specific responses; Health check responses; Error responses; Legacy compatibility responses; Core class
    APIResponse,
    created_response,
    error_response,
    forbidden_response,
...
class TestAPIResponseClass:
    ...
    def test_api_response_to_dict(self):
        ...
        response = APIResponse(
            data={"test": "data"}, message="Test message", status_code=200
        )
    ...
    def test_api_response_to_response(self):
        ...
        response = APIResponse(
            data={"test": "data"}, message="Test message", status_code=201
        )
...
class TestSuccessResponses:
    ...
    def test_success_response(self):
        ...
        response, status_code = success_response(
            data={"test": "data"}, message="Success message", meta={"key": "value"}
        )
    ...
    def test_paginated_response(self):
        ...
        response, status_code = paginated_response(
            data=data, total=10, page=2, limit=3, message="Paginated results"
        )
...
class TestDomainSpecificResponses:
    ...
    def test_search_response(self):
        ...
        response, status_code = search_response(
            results=results, query="test query", total=50
        )
...
class TestHealthCheckResponses:
    ...
    def test_health_response_success(self):
        ...
        response, status_code = health_response(
            status="ok", checks={"db": "ok", "redis": "ok"}, warnings=["warning1"]
        )
    ...
    def test_health_response_degraded(self):
        ...
        response, status_code = health_response(
            status="degraded", checks={"db": "fail"}, error="db_unreachable"
        )
    ...
    def test_redis_stats_response_success(self):
        ...
        stats = {"redis_info": {"version": "6.0.0"}, "cache_stats": {"type": "redis"}}

        response, status_code = redis_stats_response(status="ok", stats=stats)
...
class TestErrorResponses:
    ...
    def test_not_found_response(self):
        ...
        response, status_code = not_found_response(
            message="Restaurant not found", resource_type="Restaurant"
        )
    ...
    def test_validation_error_response(self):
        ...
        response, status_code = validation_error_response(
            message="Validation failed", errors=["Name is required", "Email is invalid"]
        )
        ...
        assert data["meta"]["validation_errors"] == [
            "Name is required",
            "Email is invalid",
        ]
    ...
    def test_unauthorized_response(self):
        ...
        response, status_code = unauthorized_response(
            message="Authentication required", details="Invalid token"
        )
    ...
    def test_forbidden_response(self):
        ...
        response, status_code = forbidden_response(
            message="Access denied", details="Insufficient permissions"
        )
    ...
    def test_service_unavailable_response(self):
        ...
        response, status_code = service_unavailable_response(
            message="Service temporarily unavailable", details="Database maintenance"
        )
...
class TestLegacyCompatibilityResponses:
    ...
    def test_legacy_success_response(self):
        ...
        response, status_code = legacy_success_response(
            message="Operation successful", data={"id": 123, "name": "test"}
        )
    ...
    def test_legacy_error_response_custom(self):
        ...
        response, status_code = legacy_error_response(
            message="Validation failed", status_code=400
        )

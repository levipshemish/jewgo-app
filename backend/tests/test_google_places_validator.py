...
class TestGooglePlacesValidator:
    ...
    def test_validate_website_url_strict_mode(self):
        ...
        with patch("requests.head") as mock_head:
            ...
            result = GooglePlacesValidator.validate_website_url(
                "https://example.com", strict_mode=True
            )
    ...
    def test_validate_website_url_non_strict_mode(self):
        ...
        with patch("requests.head") as mock_head:
            ...
            result = GooglePlacesValidator.validate_website_url(
                "https://example.com", strict_mode=False
            )
            assert result is True
        ...
        with patch("requests.head") as mock_head:
            ...
            with patch("requests.get") as mock_get:
                ...
                mock_get.assert_called_once_with(
                    "https://example.com", timeout=7, allow_redirects=True
                )
    ...
    def test_validate_website_url_no_fallback(self):
        ...
        with patch("requests.head") as mock_head:
            ...
            result = GooglePlacesValidator.validate_website_url(
                "https://example.com", fallback_to_get=False
            )
            assert result is False
    ...
    def test_validate_coordinates_valid(self):
        ...
        assert (
            GooglePlacesValidator.validate_coordinates(40.7128, -74.0060) is True
        )  # NYC
        assert (
            GooglePlacesValidator.validate_coordinates(0, 0) is True
        )  # Prime meridian/equator
        assert (
            GooglePlacesValidator.validate_coordinates(-90, -180) is True
        )  # Edge cases
    ...
    def test_validate_coordinates_invalid(self):
        ...
        assert (
            GooglePlacesValidator.validate_coordinates(91, 0) is False
        )  # Latitude too high
        assert (
            GooglePlacesValidator.validate_coordinates(-91, 0) is False
        )  # Latitude too low
        assert (
            GooglePlacesValidator.validate_coordinates(0, 181) is False
        )  # Longitude too high
        assert (
            GooglePlacesValidator.validate_coordinates(0, -181) is False
        )  # Longitude too low

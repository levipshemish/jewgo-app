...
class TestAPIV4Routes:
    ...
    def mock_review_service(self):
        ...
        service.get_review_by_id.return_value = {
            "id": 1,
            "restaurant_id": 1,
            "rating": 5,
        }
    ...
    def test_get_restaurants_success(
        self, mock_create_service, client, mock_restaurant_service
    ):
    ...
    def test_get_restaurants_with_filters(
        ...
        response = client.get(
            "/api/v4/restaurants?kosher_type=dairy&status=active&limit=10&offset=0"
        )
    ...
    def test_update_restaurant_success(
        ...
        update_data = {"name": "Updated Restaurant", "address": "Updated Address"}

        response = client.put(
            "/api/v4/restaurants/1",
    ...
    def test_get_reviews_success(
        self, mock_create_service, client, mock_review_service
    ):
    ...
    def test_update_review_success(
        ...
        update_data = {"rating": 4, "content": "Updated review content"}
    ...
    def test_admin_get_users_success(
        self, mock_create_service, client, mock_user_service
    ):
    ...
    def test_admin_update_user_success(
        ...
        update_data = {"userId": "user123", "isSuperAdmin": True}

...
class TestDatabaseConnectionManager:
    ...
    def test_init_with_env_var(self):
        ...
        assert db_manager.database_url == "postgresql://test:test@localhost:5432/test_db"
    ...
    def test_connect_success(self, mock_create_engine):
        ...
        with patch('utils.database_connection_manager.scoped_session', return_value=mock_session_factory):
            db_manager = DatabaseConnectionManager(self.test_db_url)
    ...
    def test_execute_query(self, mock_create_engine):
        ...
        with patch('utils.database_connection_manager.scoped_session', return_value=mock_session_factory):
            ...
            assert "SELECT * FROM restaurants WHERE city = :city" in str(call_args[0][0])
    ...
    def test_ssl_configuration(self):
        ...
        db_manager = DatabaseConnectionManager("postgresql://user:pass@neon.tech:5432/db")
    ...
    def test_local_connection_no_ssl(self):
        ...
        db_manager = DatabaseConnectionManager("postgresql://user:pass@localhost:5432/db")
    ...
    def test_neon_provider_detection(self):
        ...
        db_manager = DatabaseConnectionManager("postgresql://user:pass@ep-snowy-firefly.neon.tech:5432/db")
    ...
    def test_execute_update_with_no_affected_rows(self):
        ...
        with patch.object(db_manager, 'session_scope') as mock_session_scope:
            ...
            result = db_manager.execute_update("UPDATE restaurants SET status = 'active' WHERE id = 999")
    ...
    def test_context_manager(self):
        ...
        with patch.object(DatabaseConnectionManager, 'connect') as mock_connect, \
             patch.object(DatabaseConnectionManager, 'close') as mock_close:

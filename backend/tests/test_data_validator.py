...
class TestURLValidation:
    ...
    def test_validate_url_require_https(self):
        ...
        assert DataValidator.validate_url("https://example.com", require_https=True) is True
        assert DataValidator.validate_url("http://example.com", require_https=True) is False
...
class TestReviewDataValidation:
    ...
    def test_validate_review_data_invalid(self):
        ...
        assert "Review content must be at least 10 characters" in exc_info.value.details["errors"]
        assert "Invalid email format" in exc_info.value.details["errors"]

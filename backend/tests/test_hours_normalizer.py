...
class TestHoursNormalizer:
    ...
    def test_normalize_from_orb_dict_data(self):
        ...
        orb_data = {"hours": "Mon-Fri: 9AM-5PM", "cert_url": "https://example.com/cert"}
    ...
    def test_normalize_from_manual_valid_data(self):
        ...
        result = self.normalizer.normalize_from_manual(
            manual_data, self.timezone, "admin@test.com"
        )
    ...
    def test_create_empty_hours(self):
        ...
        result = self.normalizer._create_empty_hours(
            self.timezone, "test_source", "test error"
        )
...
class TestHoursNormalizerIntegration:
    ...
    def test_end_to_end_google_normalization(self):
        ...
        # Normalize
        normalized = normalizer.normalize_from_google(
            google_response, "America/New_York"
        )

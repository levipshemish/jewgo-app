...
class TestMonitoring:
    ...
    def test_monitoring_metrics(self):
        ...
        record_error("test_operation", "TestError", "Test error message", {"test": True})
...
class TestIntegration:
    ...
    def test_service_error_handling_integration(self):
        ...
        from utils.error_handler_v2 import handle_database_operation, create_error_context
        ...
        context = create_error_context(service="test_service", operation="test_operation")

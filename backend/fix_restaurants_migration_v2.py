#!/usr/bin/env python3
"""
Restaurants Table Migration Fix v2
==================================

This script specifically migrates the restaurants table from Neon to Oracle Cloud,
using proper SQLAlchemy parameter binding to handle JSON/dict data correctly.
"""
...
def main():
    ...
    print("🔄 Restaurants Table Migration Fix v2")
    print("=" * 40)
    ...
    # Create migrator
    migrator = RestaurantsMigratorV2(neon_url, oracle_url)

...
class OpenNowService:
    ...
    def _parse_regular_hours(self, text: str) -> tuple[Optional[DayOfWeek], Optional[time], Optional[time]]:
        ...
        try:
            ...
            if match:
                ...
                close_time = self._convert_to_24hour(close_hour, close_minute, close_period)
        ...
        try:
            ...
            if today_hours.open_time and today_hours.close_time:
                ...
                if today_hours.close_time < today_hours.open_time:
                    # Overnight hours
                    return (current_time_obj >= today_hours.open_time or 
                           current_time_obj <= today_hours.close_time)
                else:
                    # Regular hours
                    return (today_hours.open_time <= current_time_obj <= today_hours.close_time)
    ...
    def _parse_structured_hours(self, hours_json: Union[str, Dict]) -> List[BusinessHours]:

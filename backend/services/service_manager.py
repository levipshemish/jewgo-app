...
def get_service_manager() -> ServiceManager:
    ...
    if _service_manager is None:
        raise RuntimeError("Service manager not initialized. Call initialize_service_manager() first.")
    return _service_manager


def initialize_service_manager(db_manager=None, config=None, cache_manager=None) -> ServiceManager:

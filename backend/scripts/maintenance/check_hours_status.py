...
def check_hours_status():
    ...
    try:
        ...
        hours_json_query = text("SELECT COUNT(*) FROM restaurants WHERE hours_json IS NOT NULL")
        
        # Check restaurants with hours_of_operation
        hours_text_query = text("SELECT COUNT(*) FROM restaurants WHERE hours_of_operation IS NOT NULL AND hours_of_operation != ''")
        
        # Check restaurants with google_place_id
        google_place_query = text("SELECT COUNT(*) FROM restaurants WHERE google_place_id IS NOT NULL AND google_place_id != ''")

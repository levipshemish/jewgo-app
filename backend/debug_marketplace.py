...
def main():
    ...
    env = os.environ.copy()
    env['PORT'] = '5001'
    env['DATABASE_URL'] = 'postgresql+psycopg://neondb_owner:npg_75MGzUgStfuO@ep-snowy-firefly-aeeo0tbc-pooler.c-2.us-east-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require'

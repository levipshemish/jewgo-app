...
class DatabaseConnectionManager:
    ...
    def _create_engine(self):
        ...
        is_neon_pooler = 'pooler' in parsed_url.hostname if parsed_url.hostname else False
        ...
        if not is_neon_pooler:
            ...
            logger.info("Using Neon pooled connection - skipping statement_timeout parameter")

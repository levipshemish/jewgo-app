...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "order_id", sa.String(100), unique=True, nullable=False
        ),  # UUID for order
        ...
        sa.Column(
            "customer_user_id", sa.String(100), nullable=False
        ...
        # 💳 Payment Information
        sa.Column(
            "payment_method", sa.String(50), nullable=True
        ),  # credit_card, paypal, etc.
        sa.Column(
            "payment_status", sa.String(20), nullable=False, default="pending"
        ),  # pending, paid, failed, refunded
        sa.Column("payment_transaction_id", sa.String(255), nullable=True),
        sa.Column("stripe_payment_intent_id", sa.String(255), nullable=True),
        # 📦 Order Status & Fulfillment
        sa.Column(
            "order_status", sa.String(20), nullable=False, default="pending"
        ),  # pending, confirmed, processing, shipped, delivered, cancelled
        sa.Column(
            "fulfillment_method", sa.String(20), nullable=False, default="pickup"
        ...
        sa.Column(
            "preferred_delivery_time", sa.String(50), nullable=True
        ...
        sa.Column(
            "kosher_certification_required", sa.Boolean, default=False, nullable=False
        ),
        ...
        sa.Column(
            "special_instructions", sa.Text, nullable=True
        ),  # Kosher instructions, etc.
        # 📝 Notes & Communication
        ...
        sa.Column(
            "refund_status", sa.String(20), nullable=True
        ...
        sa.Column(
            "order_type", sa.String(50), nullable=True
        ),  # regular, bulk, wholesale, gift
        sa.Column(
    ...
    op.create_index(
        "idx_shtetl_orders_customer_user_id", "shtetl_orders", ["customer_user_id"]
    )
    ...
    op.create_index(
        "idx_shtetl_orders_payment_status", "shtetl_orders", ["payment_status"]
    )
    ...
    op.create_index(
        "idx_shtetl_orders_customer_status",
        "shtetl_orders",
        ["customer_user_id", "order_status"],
    )
    op.create_index(
        "idx_shtetl_orders_store_date", "shtetl_orders", ["store_id", "created_at"]
    )
    op.create_index(
        "idx_shtetl_orders_payment_date",
        "shtetl_orders",

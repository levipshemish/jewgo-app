...
def apply_migration():
    ...
    try:
        ...
        print("Applying merge_anonymous_user_data function and merge_jobs table migration...")
        ...
        try:
            ...
            print(f"✅ Function test successful, returned: {result[0] if result else 'None'}")
        except Exception as e:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Apply or rollback merge_anonymous_user_data migration")

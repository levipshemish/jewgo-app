#!/usr/bin/env python3
"""Database Migration: Create Marketplace Schema (Simplified).
=======================================================

This migration creates the marketplace schema with better error handling
and existing table compatibility.
            ...
            try:
                ...
                conn.execute(text("""
                    CREATE TABLE IF NOT EXISTS listing_transactions (
                        ...
                        buyer_user_id TEXT NOT NULL, -- Will be UUID when users table is ready
                        seller_user_id TEXT, -- Will be UUID when users table is ready

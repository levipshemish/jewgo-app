...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "store_id", sa.String(100), unique=True, nullable=False
        ),  # UUID for store
        ...
        sa.Column(
            "owner_user_id", sa.String(100), nullable=False
        ...
        sa.Column(
            "store_type", sa.String(100), nullable=False
        ),  # grocery, clothing, electronics, etc.
        sa.Column(
            "store_category", sa.String(100), nullable=False
        ),  # kosher, general, specialty, etc.
        ...
        # 💳 Payment & Billing
        sa.Column(
            "plan_type", sa.String(20), default="free", nullable=False
        ),  # free, basic, premium
        ...
        sa.Column(
            "social_media", JSONB, nullable=True
        ),  # JSON object for social media links
        ...
        sa.Column(
            "integrations", JSONB, nullable=True
        ),  # JSON object for third-party integrations
        ...
        sa.Column(
            "jewish_holiday_hours", JSONB, nullable=True
        ),  # Special hours for Jewish holidays
        ...
        sa.Column(
            "delivery_zones", JSONB, nullable=True
        ),  # JSON array of delivery zones
        sa.Column(
    ...
    op.create_index(
        "idx_shtetl_stores_store_category", "shtetl_stores", ["store_category"]
    )
    ...
    op.create_index(
        "idx_shtetl_stores_kosher_agency", "shtetl_stores", ["kosher_agency"]
    )
    ...
    op.create_index(
        "idx_shtetl_stores_city_kosher", "shtetl_stores", ["city", "kosher_agency"]
    )
    op.create_index(
        "idx_shtetl_stores_active_approved",
        "shtetl_stores",

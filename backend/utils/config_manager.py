...
class ConfigManager:
    ...
    @classmethod
    def get_env_var_list(
        cls, key: str, default: List[str] = None, separator: str = ","
    ) -> List[str]:
        ...
        try:
            ...
            logger.warning(
                f"Invalid list value for {key}: {value}, using default: {default}"
            )
            return default
    ...
    def get_google_places_api_key(cls) -> Optional[str]:
        ...
        return cls.get_env_var("GOOGLE_PLACES_API_KEY") or cls.get_env_var(
            "GOOGLE_API_KEY"
        )
    ...
    def get_google_maps_api_key(cls) -> Optional[str]:
        ...
        return cls.get_env_var("GOOGLE_MAPS_API_KEY") or cls.get_env_var(
            "GOOGLE_API_KEY"
        )
    ...
    def validate_required_config(cls) -> List[str]:
        ...
        required_keys = ["DATABASE_URL", "FLASK_SECRET_KEY", "JWT_SECRET_KEY"]

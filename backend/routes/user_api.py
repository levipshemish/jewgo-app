...
def update_user_profile():
    ...
    try:
        ...
        if 'display_name' in update_data and not isinstance(update_data['display_name'], str):
            raise ValidationError("display_name must be a string")
        
        if 'avatar_url' in update_data and not isinstance(update_data['avatar_url'], str):
...
def remove_favorite(restaurant_id):
    ...
    try:
        ...
        logger.info(f"User {user_id} removing restaurant {restaurant_id} from favorites")

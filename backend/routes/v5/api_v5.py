...
def get_entities(entity_type: str):
    ...
    try:
        ...
        etag = etag_manager.generate_etag(result['data'], entity_type)
...
def get_entity(entity_type: str, entity_id: int):
    ...
    try:
        ...
        # Generate ETag for caching
        etag = etag_manager.generate_etag(entity, f"{entity_type}_{entity_id}")
...
def update_entity(entity_type: str, entity_id: int):
    ...
    try:
        ...
        # Invalidate related caches
        etag_manager.invalidate_etag(entity_type)
        etag_manager.invalidate_etag(f"{entity_type}_{entity_id}")

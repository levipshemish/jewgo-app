...
def get_mikvah():
    ...
    try:
        ...
        try:
            ...
            mikvah_facilities = db_manager.execute_query(data_query, where_params)
...
def get_mikvah_facility(mikvah_id: int):
    ...
    try:
        ...
        try:
            ...
            mikvah_result = db_manager.execute_query(mikvah_query, [mikvah_id, True])
            
            if not mikvah_result:
                return jsonify({
                    'success': False,

...
CREATE TABLE "UserProfile" (
    ...
    "favoriteCertifications" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "specials" BOOLEAN NOT NULL DEFAULT true,
    "newRestaurants" BOOLEAN NOT NULL DEFAULT true,
    "menuUpdates" BOOLEAN NOT NULL DEFAULT true,
    "shabbatReminders" BOOLEAN NOT NULL DEFAULT false,
    "certificationUpdates" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

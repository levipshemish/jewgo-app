...
declare namespace google.maps {
  ...
  function addListenerOnce(instance: unknown, eventName: string, handler: (...args: unknown[]) => void): MapsEventListener;
  ...
  namespace places {
    ...
    class Place {
      ...
      fetchFields(options: { fields: string[] }): Promise<PlaceResult>;
    }

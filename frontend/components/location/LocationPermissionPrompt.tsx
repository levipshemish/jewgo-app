...
export default function LocationPermissionPrompt({
  onLocationGranted, onLocationDenied, onDismiss, onLocationRequest
  ...
  const requestLocation = () => {
    ...
    // Notify parent component that location request is starting
    onLocationRequest?.();
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6 border border-gray-200">
        ...
        <div className="mt-4 text-xs text-gray-500 text-center">
          If the location request doesn&apos;t work, please check your browser&apos;s location permissions in the address bar.
        </div>
      </div>
    </div>
  );

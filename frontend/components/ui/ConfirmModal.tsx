...
export default function ConfirmModal({ 
  isOpen, onClose, onConfirm, title, message, confirmText = 'Confirm', cancelText = 'Cancel', confirmColor = 'blue', isLoading = false
}: ConfirmModalProps) {
  // Handle escape key
  useEffect(() => {
  ...
  const getConfirmButtonClass = () => {
    const baseClass = "flex-1 px-4 py-2 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed";

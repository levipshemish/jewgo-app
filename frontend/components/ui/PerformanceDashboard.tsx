...
// Use the PerformanceEvent type from the performance monitor
  ...
  return (
    <div className={`bg-white rounded-lg shadow-md p-6 ${className}`}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="text-center">
          <div className="text-2xl font-bold text-blue-600">{safeFilter(events, (e: PerformanceEvent) => e.category === 'navigation').length}</div>
          <div className="text-sm text-gray-600">Navigation Events</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-green-600">{safeFilter(events, (e: PerformanceEvent) => e.category === 'component').length}</div>
                  ...
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      <div className={`w-2 h-2 rounded-full ${
                        ...
                        event.category === 'paint' ? 'bg-yellow-500' :
                        event.category === 'layout' ? 'bg-purple-500' :
                        'bg-gray-500'
                      }`} />
                      <div>

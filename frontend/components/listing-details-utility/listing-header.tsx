      ...
      <div className="inline-flex items-center px-4 py-2.5 rounded-full mt-8 shadow-lg max-w-full backdrop-blur-md bg-white/80 border border-white/20 dark:bg-white/14 dark:border-white/22 overflow-hidden" style={{ boxShadow: '0 2px 8px rgba(0, 0, 0, 0.15)' }}>
        ...
        {onBack && (
          <Button 
            ...
            size="icon" 
            onClick={onBack} 
            className="h-10 w-10 p-0 m-0 min-w-0 min-h-0 max-w-10 max-h-10 hover:bg-gray-100 transition-colors"
            style={{ padding: 0, margin: 0, minWidth: 0, minHeight: 0, maxWidth: '2.5rem', maxHeight: '2.5rem' }}
          >
        ...
        {kosherType && (
          <>
            ...
            <span className={`text-base font-semibold m-0 whitespace-nowrap flex-shrink-0 ${
        ...
        {viewCount !== undefined && viewCount >= 0 && (
          <>
            ...
            <div className="flex items-center gap-1.5 text-gray-600 m-0 whitespace-nowrap flex-shrink-0">
              ...
              <span className="text-base font-semibold">{viewCount >= 1000 ? `${(viewCount / 1000).toFixed(1)}k` : viewCount}</span>
            </div>
          </>
        )}
        ...
        {shareCount !== undefined && (
          <>
            ...
            <Button
              ...
              size="icon"
              onClick={handleShare}
              className="h-10 w-10 p-0 m-0 min-w-0 min-h-0 max-w-10 max-h-10 hover:bg-gray-100 transition-colors flex-shrink-0"
              style={{ padding: 0, margin: 0, minWidth: 0, minHeight: 0, maxWidth: '2.5rem', maxHeight: '2.5rem' }}
            >
        ...
        {onFavorite && (
          <>
            ...
            <Button
              ...
              size="icon"
              onClick={onFavorite}
              className="h-10 w-10 p-0 m-0 min-w-0 min-h-0 max-w-10 max-h-10 hover:bg-gray-100 transition-colors group flex-shrink-0"
              style={{ padding: 0, margin: 0, minWidth: 0, minHeight: 0, maxWidth: '2.5rem', maxHeight: '2.5rem' }}
            >
              <Heart

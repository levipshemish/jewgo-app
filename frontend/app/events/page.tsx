  ...
  const _handleTabChange = (tab: string) => {
    ...
    switch (tab) {
      ...
      case 'stores':
        ...
        break;
      case 'events':
        // Already on events page, just update the tab
        break;
      default:
        break;
    }
        ...
        <div className="text-center max-w-md mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-500 mb-8">
              We&apos;re working hard to bring you a comprehensive events calendar with Jewish holidays, 
              community events, and local gatherings. This feature will be available soon.
            </p>
            <button

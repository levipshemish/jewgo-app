...
echo ""
echo "# Turnstile Configuration (use your existing keys)"
echo "vercel secrets add turnstile-secret-key \"your-turnstile-secret-key\""
echo "vercel secrets add turnstile-site-key \"0x4AAAAAABuBu7lWKado8L_e\""
echo ""

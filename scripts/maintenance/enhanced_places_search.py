...
class EnhancedPlacesSearch:
    ...
    def search_place_enhanced(
        ...
        return searcher.search_place(name, address, city, state, search_type="enhanced")
    ...
    def get_place_details(
        self, place_id: str, fields: str = "opening_hours,formatted_address,name"
    ) -> Optional[Dict[str, Any]]:
        """Get detailed information about a place."""
        searcher = GooglePlacesSearcher(self.api_key)
        field_list = fields.split(",") if isinstance(fields, str) else fields
        return searcher.get_place_details(place_id, field_list)
    ...
    def run(self, limit: int = None):
        ...
        try:
            ...
            logger.info(
                f"Found {len(restaurants)} restaurants to retry with enhanced search"
            )

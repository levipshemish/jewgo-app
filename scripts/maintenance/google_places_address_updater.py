...
class GooglePlacesAddressUpdater:
            ...
            if data["status"] == "OK" and data["results"]:
                ...
                if detailed_info:
                    return {
                        ...
                        "address_components": detailed_info.get(
                            "address_components", []
                        ),
                        ...
                        "formatted_phone_number": detailed_info.get(
    ...
    def update_restaurant_address(self, restaurant_id: int, address_data: Dict) -> bool:
        ...
        try:
            ...
            address_components = self.extract_address_components(
                address_data.get("address_components", [])
            )
    ...
    def process_restaurants(self, limit: Optional[int] = None) -> Dict[str, int]:
        ...
        for i, (restaurant_id, name, address, city, state, zip_code) in enumerate(
            restaurants, 1
        ):
    ...
    def generate_report(self, results: Dict[str, int]) -> str:
        ...
        """
        success_rate = (
            (results["updated"] / results["total_processed"] * 100)
